        ...
        <div className="flex flex-col gap-8">
          <form onSubmit={saveSettings} className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Set a time to receive a browser push notification so you don't break your streak.
              </p>
              <Input
                type="time"
                value={tempTime}
            ...
            <button
              type="submit"
              className="h-10 px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg font-medium transition-colors"
            >
              Save Preferences
            </button>
          </form>
          ...
          <div className="border-t border-border pt-6">
            ...
            <p className="text-xs text-muted-foreground mb-4">
              Since consistly currently stores everything directly in your browser, you can export
              your data to back it up or import it on another device. When Cloud Sync launches, you
              will be able to upload this backup file to your account!
            </p>
